...
public class DRIPPING_DRIPSTONE_LAVA extends BaseParticleType {

    public DRIPPING_DRIPSTONE_LAVA() {
        super();  // 调用父类的构造函数
    }

    @Override
    public @NotNull BaseParticleType getType() {
        return ModParticleType.DRIPPING_DRIPSTONE_LAVA.get();  // 返回自定义的粒子类型
    }
}
