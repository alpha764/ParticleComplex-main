...
public class AntiElectricChargeVecExp {
    StringBuilder vecExpX;
    StringBuilder vecExpY;
    StringBuilder vecExpZ;

//    默认k=1,F=q1q2/r^2
    public AntiElectricChargeVecExp(double q1, List<Double> q2s, List<Vector3d> poses){
    ...
    public AntiElectricChargeVecExp(double q1, List<Double> q2s, int entityAmount){
        vecExpX= new StringBuilder();
        vecExpY= new StringBuilder();
        vecExpZ= new StringBuilder();
    ...
    public static void main(String[] args){
        ...
        AntiElectricChargeVecExp electricChargeVecExp=new AntiElectricChargeVecExp(3,q2s,1);
