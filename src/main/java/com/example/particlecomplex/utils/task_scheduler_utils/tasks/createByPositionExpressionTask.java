...
public class createByPositionExpressionTask extends Task {
    ...
    public createByPositionExpressionTask(ParticleAreaSpawner areaSpawner, float x, float y, float z, int delay) {
        super(delay);
        this.x = x;
        this.y = y;
        this.z = z;
    ...
    @Override
    public void execute() {
        this.areaSpawner.createByPositionExpression(x, y, z);
    }
}
